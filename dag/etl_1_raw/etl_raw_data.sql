...
FROM '/app/peg_etl/raw_data/Customer.csv'
...
FROM '/app/peg_etl/raw_data/Contract.csv'
DELIMITER ',' CSV HEADER
;
...
FROM '/app/peg_etl/raw_data/Product.csv'
DELIMITER ',' CSV HEADER
;
...
FROM '/app/peg_etl/raw_data/Transaction.csv'
DELIMITER ',' CSV HEADER
;
