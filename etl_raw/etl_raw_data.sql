...
FROM '/app/peg_etl/data/Customer.csv'
...
FROM '/app/peg_etl/data/Contract.csv'
DELIMITER ',' CSV HEADER
;
...
FROM '/app/peg_etl/data/Product.csv'
DELIMITER ',' CSV HEADER
;
...
FROM '/app/peg_etl/data/Transaction.csv'
DELIMITER ',' CSV HEADER
;
