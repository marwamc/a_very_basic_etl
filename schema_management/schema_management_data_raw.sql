...
-- raw customer
CREATE TABLE IF NOT EXISTS data_raw.customer(
  customer_id char(25),
  first_name char(25),
  last_name char(25),
...
-- raw contract
CREATE TABLE IF NOT EXISTS data_raw.contract(
  contract_id char(25),
  customer_id char(25),
  product_id char(25),
  created_at char(100),
...
-- raw product
CREATE TABLE IF NOT EXISTS data_raw.product(
  product_id char(25),
...
-- raw transaction
CREATE TABLE IF NOT EXISTS data_raw.transaction(
